...
import logoHorizon from '@/images/logos/horizon-logo.png'
import logoRMC from '@/images/logos/rmcaarows.png'
import logoMRM from '@/images/logos/mrm.png'
...
function Article({article}: { article: ArticleWithSlug }) {
    return (
        <Card as="article">
            ...
            <Card.Cta>View Project Overview</Card.Cta>
        </Card>
    )
}
            ...
            <Container className="mt-9">
                <div className="max-w-2xl">
                    <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
                        Full-stack Developer @ Freelance | Ruby on Rails | JavaScript | PHP | HTML | CSS | Client
                        Focused
                    </h1>
                    <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                        ...
                        department for the last couple of years, ensuring 95% uptime and 88% adoption for
